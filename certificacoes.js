(() => {
  ...
  const UI = {
    pt:{
      ...
      back:'← Portfólio', title:'Certificações', status:'Em atualização', catalogTitle:'Certificados', languageGroup:'Selecionar idioma',
    ...
    en:{
      ...
      back:'← Portfolio', title:'Certifications', status:'Being updated', catalogTitle:'Certificates', languageGroup:'Select language',
    ...
    es:{
      ...
      back:'← Portafolio', title:'Certificaciones', status:'En actualización', catalogTitle:'Certificados', languageGroup:'Seleccionar idioma',
